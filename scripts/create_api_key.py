...
Reads DATABASE_URL (or the legacy GSE_MCP_DATABASE_URL) from the environment.
"""
...
def main() -> None:
    ...
    database_url = os.environ.get("DATABASE_URL") or os.environ.get("GSE_MCP_DATABASE_URL")
    if not database_url:
